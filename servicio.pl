...
if(Win32::Daemon::CreateService($service_info)){
	...
	confess 'ERROR instalando el servicio: '.Win32::FormatMessage(Win32::Daemon::GetLastError());
}
return;
}
...
if(Win32::Daemon::DeleteService('', $NOMBRE)){
	...
	confess 'ERROR desinstalando el servicio: '.Win32::FormatMessage(Win32::Daemon::GetLastError());
}
return;
}
